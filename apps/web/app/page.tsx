    ...
    <div className="flex min-h-screen flex-col">
      <header className="border-b bg-white">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Link href="/register">
              <Button className="bg-gradient-to-r from-blue-500 to-violet-500 text-white">Sign Up</Button>
            </Link>
          </nav>
        </div>
      </header>
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-12 md:grid-cols-2 md:items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600">
                  Chat with random strangers, share moments, and make new friends in a safe and friendly environment.
                </p>
                <div className="flex flex-col gap-4 sm:flex-row">
                  <Link href="/login">
                    <Button size="lg" className="bg-gradient-to-r from-blue-500 to-violet-500 text-white">
        ...
        <section className="py-16">
          <div className="container">
            <h2 className="mb-12 text-center text-3xl font-bold text-gray-900">Why Choose ChatConnect?</h2>
            <div className="grid gap-8 md:grid-cols-3">
              {[
                {
                  title: "Meet New People",
                  description: "Connect with random strangers from around the world and expand your social circle.",
                  icon: "👋",
                },
                {
                  title: "Share Media",
                  description: "Exchange images, GIFs, and text messages to express yourself better.",
                  icon: "🖼️",
                },
                {
                  title: "Stay Safe",
                  description: "Our reporting system ensures a safe environment for everyone.",
                  icon: "🛡️",
                },
              ].map((feature, index) => (
                <div
      ...
      <footer className="border-t bg-gray-50 py-8">
        <div className="container">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="text-sm text-gray-500">© {new Date().getFullYear()} ChatConnect. All rights reserved.</div>
          </div>
        </div>
      </footer>
    </div>
