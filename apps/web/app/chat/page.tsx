...
import { Send, ImageIcon, Smile, UserPlus, Flag, X, RefreshCw } from "lucide-react"
            ...
            <div className="grid w-full grid-cols-2 border rounded-md overflow-hidden">
              <button
                className={`p-2 text-sm font-medium transition-colors ${
                  activeTab === "chat" ? "bg-white text-black" : "bg-gray-100 text-gray-600"
                }`}
              ...
              <button
                className={`p-2 text-sm font-medium transition-colors ${
                  activeTab === "friends" ? "bg-white text-black" : "bg-gray-100 text-gray-600"
                }`}
                ...
                isConnected && (
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-base font-semibold">{stranger.name}</div>
                        <p className="text-xs text-gray-500">Online</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <Button variant="ghost" size="sm" onClick={handleAddFriend} title="Add Friend">
                        <UserPlus className="h-5 w-5 text-gray-600" />
                      </Button>
                      <Button variant="ghost" size="sm" onClick={handleReportUser} title="Report User">
                        <Flag className="h-5 w-5 text-gray-600" />
                      </Button>
                      <Button variant="ghost" size="sm" onClick={handleEndChat} title="End Chat">
                  ...
                  {isTyping && (
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-1">
                        ...
                        <div className="h-2 w-2 animate-bounce rounded-full bg-gray-400" style={{ animationDelay: "200ms" }} />
                        <div className="h-2 w-2 animate-bounce rounded-full bg-gray-400" style={{ animationDelay: "400ms" }} />
                      </div>
                    </div>
                  )}
